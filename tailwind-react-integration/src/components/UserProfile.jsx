function UserProfile() {
  return (
    <div className="user-profile container bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg md:max-w-sm md:p-8 sm:max-w-xs sm:p-4 hover:shadow-xl">
